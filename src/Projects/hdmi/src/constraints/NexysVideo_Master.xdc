...
set_property PACKAGE_PIN T14 [get_ports {Red_Health[0]}]
set_property PACKAGE_PIN T15 [get_ports {Red_Health[1]}]
set_property PACKAGE_PIN T16 [get_ports {Red_Health[2]}]
set_property PACKAGE_PIN U16 [get_ports {Blue_Health[0]}]
set_property PACKAGE_PIN V15 [get_ports {Blue_Health[1]}]
set_property PACKAGE_PIN W16 [get_ports {Blue_Health[2]}]
set_property PACKAGE_PIN Y13 [get_ports red_dead]
set_property PACKAGE_PIN W15 [get_ports blue_dead]
set_property PACKAGE_PIN E22 [get_ports s00_axis_aresetn]
#set_property PACKAGE_PIN F21 [get_ports {manual_threshold[0]}]
#set_property PACKAGE_PIN G21 [get_ports {manual_threshold[1]}]
#set_property PACKAGE_PIN G22 [get_ports {manual_threshold[2]}]
#set_property PACKAGE_PIN H17 [get_ports {manual_threshold[3]}]
#set_property PACKAGE_PIN J16 [get_ports {manual_threshold[4]}]
#set_property PACKAGE_PIN K13 [get_ports {manual_threshold[5]}]
#set_property PACKAGE_PIN M17 [get_ports {manual_threshold[6]}]
set_property IOSTANDARD LVCMOS25 [get_ports {Red_Health[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {Red_Health[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {Red_Health[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {Blue_Health[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {Blue_Health[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {Blue_Health[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports blue_dead]
set_property IOSTANDARD LVCMOS25 [get_ports red_dead]
set_property IOSTANDARD LVCMOS25 [get_ports s00_axis_aresetn]
#set_property IOSTANDARD LVCMOS25 [get_ports {manual_threshold[0]}]
#set_property IOSTANDARD LVCMOS25 [get_ports {manual_threshold[1]}]
#set_property IOSTANDARD LVCMOS25 [get_ports {manual_threshold[2]}]
#set_property IOSTANDARD LVCMOS25 [get_ports {manual_threshold[3]}]
#set_property IOSTANDARD LVCMOS25 [get_ports {manual_threshold[4]}]
#set_property IOSTANDARD LVCMOS25 [get_ports {manual_threshold[5]}]
#set_property IOSTANDARD LVCMOS25 [get_ports {manual_threshold[6]}]