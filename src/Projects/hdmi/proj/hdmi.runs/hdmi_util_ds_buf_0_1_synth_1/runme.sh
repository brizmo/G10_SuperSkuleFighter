...
HD_PWD='W:/327_2/NexysVideo-master/Projects/hdmi/proj/hdmi.runs/hdmi_util_ds_buf_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_util_ds_buf_0_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_util_ds_buf_0_1.tcl
