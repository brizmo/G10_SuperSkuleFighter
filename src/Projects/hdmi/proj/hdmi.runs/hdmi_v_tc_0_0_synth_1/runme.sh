...
HD_PWD='W:/feed_through/NexysVideo-master/Projects/hdmi/proj/hdmi.runs/hdmi_v_tc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_v_tc_0_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_v_tc_0_0.tcl
