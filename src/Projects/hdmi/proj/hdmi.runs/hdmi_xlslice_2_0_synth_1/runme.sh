...
HD_PWD='W:/feed_through/NexysVideo-master/Projects/hdmi/proj/hdmi.runs/hdmi_xlslice_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_xlslice_2_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_xlslice_2_0.tcl
