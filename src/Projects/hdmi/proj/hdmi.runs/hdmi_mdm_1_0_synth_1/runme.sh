...
HD_PWD='W:/feed_through/NexysVideo-master/Projects/hdmi/proj/hdmi.runs/hdmi_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_mdm_1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_mdm_1_0.tcl
