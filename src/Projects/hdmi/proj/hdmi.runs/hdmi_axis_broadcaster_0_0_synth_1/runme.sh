...
HD_PWD='W:/ECE532/0327_colors/NexysVideo-master/Projects/hdmi/proj/hdmi.runs/hdmi_axis_broadcaster_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_axis_broadcaster_0_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_axis_broadcaster_0_0.tcl
