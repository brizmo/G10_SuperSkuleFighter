...
HD_PWD='W:/ECE532/0327_colors/NexysVideo-master/Projects/hdmi/proj/hdmi.runs/hdmi_axi_vdma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_axi_vdma_0_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_axi_vdma_0_0.tcl
