...
HD_PWD='W:/ECE532/0327_colors/NexysVideo-master/Projects/hdmi/proj/hdmi.runs/hdmi_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_xbar_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_xbar_1.tcl
