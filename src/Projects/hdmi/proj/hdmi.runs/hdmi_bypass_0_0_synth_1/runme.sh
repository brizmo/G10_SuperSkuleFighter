...
HD_PWD='W:/pre_done/NexysVideo-master/Projects/hdmi/proj/hdmi.runs/hdmi_bypass_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_bypass_0_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_bypass_0_0.tcl
