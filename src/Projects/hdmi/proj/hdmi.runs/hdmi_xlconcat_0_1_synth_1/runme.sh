...
HD_PWD='W:/feed_through/NexysVideo-master/Projects/hdmi/proj/hdmi.runs/hdmi_xlconcat_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_xlconcat_0_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_xlconcat_0_1.tcl
