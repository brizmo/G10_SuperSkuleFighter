...
HD_PWD='C:/Users/Mohammad/Desktop/ECE532/src/Projects/hdmi/proj/hdmi.runs/hdmi_auto_rs_w_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_auto_rs_w_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_auto_rs_w_1.tcl
